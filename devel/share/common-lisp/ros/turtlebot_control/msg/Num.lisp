...
(cl:in-package turtlebot_control-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_control-msg:<Num> is deprecated: use turtlebot_control-msg:Num instead.")))

(cl:ensure-generic-function 'num-val :lambda-list '(m))
(cl:defmethod num-val ((m <Num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_control-msg:num-val is deprecated.  Use turtlebot_control-msg:num instead.")
  (num m))
